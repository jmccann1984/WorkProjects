...
CREATE TABLE `directory` (
  ...
  `DirectoryName` varchar(100) DEFAULT NULL,
  ...
  CONSTRAINT `directory_DirectoryPathId` FOREIGN KEY (`DirectoryPathId`) REFERENCES `directory` (`DirectoryId`) ON DELETE CASCADE ON UPDATE CASCADE
