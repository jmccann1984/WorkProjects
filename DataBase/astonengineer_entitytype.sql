...
CREATE TABLE `entitytype` (
  ...
  KEY `FK_EntityType_EntityId` (`EntityId`),
  CONSTRAINT `FK_EntityType_EntityId` FOREIGN KEY (`EntityId`) REFERENCES `entity` (`EntityId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `entitytype` VALUES (1,'Work',1),(2,'Personal',1),(3,'Airline',2),(4,'Car Rental',2),(5,'Work',3),(6,'Home',3),(7,'Cell',3);
