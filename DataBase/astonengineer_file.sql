...
CREATE TABLE `file` (
  ...
  CONSTRAINT `File_FileDirectoryId` FOREIGN KEY (`DirectoryId`) REFERENCES `directory` (`DirectoryId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `File_FileTypeId` FOREIGN KEY (`FileTypeId`) REFERENCES `filetype` (`FileTypeId`) ON DELETE CASCADE ON UPDATE CASCADE
