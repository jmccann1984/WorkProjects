...
CREATE TABLE `projectstatus` (
  ...
  KEY `FK_ProjectStatus_ProjectId` (`ProjectId`),
  KEY `FK_ProjectStatus_EntityTypeId` (`EntityTypeId`),
  CONSTRAINT `FK_ProjectStatus_EntityTypeId` FOREIGN KEY (`EntityTypeId`) REFERENCES `entitytype` (`EntityTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_ProjectStatus_ProjectId` FOREIGN KEY (`ProjectId`) REFERENCES `project` (`ProjectId`) ON DELETE NO ACTION ON UPDATE NO ACTION
