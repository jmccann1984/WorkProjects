...
CREATE TABLE `training` (
  ...
  KEY `FK_Training_EmployeeId` (`EmployeeId`),
  CONSTRAINT `FK_Training_EmployeeId` FOREIGN KEY (`EmployeeId`) REFERENCES `employee` (`EmployeeId`) ON DELETE NO ACTION ON UPDATE NO ACTION
