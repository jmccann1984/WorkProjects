...
CREATE TABLE `trainingdata` (
  `TrainingDateId` int(11) NOT NULL,
  `TrainingId` int(11) NOT NULL,
  `EntityTypeId` int(11) NOT NULL,
  `TrainingDataValue` varchar(8000) NOT NULL,
  `CreateDate` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`TrainingId`,`EntityTypeId`),
  KEY `FK_TrainingData_EntityTypeId` (`EntityTypeId`),
  CONSTRAINT `FK_TrainingData_EntityTypeId` FOREIGN KEY (`EntityTypeId`) REFERENCES `entitytype` (`EntityTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_TrainingData_TrainingId` FOREIGN KEY (`TrainingId`) REFERENCES `training` (`TrainingId`) ON DELETE NO ACTION ON UPDATE NO ACTION
